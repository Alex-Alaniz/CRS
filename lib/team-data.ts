...
export const leadership: TeamProfile[] = [
  {
    ...
    initials: "CC",
    image: "/team/ceo.jpg",
    imageAlt: "CRS founder profile portrait",
...
export const teamMembers: TeamProfile[] = [
  ...
  {
    name: "Wilson Altamirano",
    role: "CSST / CSSS SAFETY PROFESSIONAL",
    initials: "WA",
    bio: "Wilson Altamirano brings CSST and CSSS safety credentials to CRS client coverage where certified site safety experience and field coordination are needed.",
    department: "FIELD",
